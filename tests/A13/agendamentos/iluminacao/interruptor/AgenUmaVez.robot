...
Agendamento Smart Interruptor WiFi 2 Ligar - Uma vez - Acionar C1
    ...
    E defino os dias e ações    ${btn_novo_agendamento}    Uma vez    ${btn_novo_agendamento}    Agenda C1    ${btn_novo_agendamento}
...
Agendamento Smart Interruptor WiFi 2 Ligar - Uma vez - Acionar C2
    ...
    E defino os dias e ações    ${btn_novo_agendamento}    Uma vez    ${btn_novo_agendamento}    Agenda C2    ${btn_novo_agendamento}
    Então o agendamento do Interruptor é criado com sucesso
...
Agendamento Smart Interruptor WiFi 2 Ligar - Uma vez - Acionar C3
    ...
    E defino os dias e ações    ${btn_novo_agendamento}    Uma vez    ${btn_novo_agendamento}    Agenda C3    ${btn_novo_agendamento}
    Então o agendamento do Interruptor é criado com sucesso   
...
Agendamento Smart Interruptor WiFi 2 Ligar - Uma vez - Acionar C1 e C2
    ...
    E defino os dias e ações    ${btn_novo_agendamento}    Uma vez    ${btn_novo_agendamento}    Agenda C1 C2    ${btn_novo_agendamento}
    Então o agendamento do Interruptor é criado com sucesso 
...
Agendamento Smart Interruptor WiFi 2 Ligar - Uma vez - Acionar C1, C2 e C3
    ...
    E defino os dias e ações    ${btn_novo_agendamento}    Uma vez    ${btn_novo_agendamento}    Agenda Todos C    ${btn_novo_agendamento}
    Então o agendamento do Interruptor é criado com sucesso  
...
Agendamento Smart Interruptor WiFi 2 Ligar - Uma vez - Acionar C1 e C3
    ...
    E defino os dias e ações    ${btn_novo_agendamento}    Uma vez    ${btn_novo_agendamento}    Agenda C1 C3    ${btn_novo_agendamento}
    Então o agendamento do Interruptor é criado com sucesso              